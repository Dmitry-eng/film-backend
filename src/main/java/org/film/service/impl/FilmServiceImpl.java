...
import static org.film.util.ConstantStorageUtils.IMAGES_BUCKET_NAME;
...
public class FilmServiceImpl implements FilmService {
    ...
    public FullFilmInfo createFilm(CreateFilm film) {
        ...
        FullFilmInfo fullFilmInfo = filmMapper.mapFullFilmInfo(savedFilmEntity);

        List<Image> images = Optional.of(savedFilmEntity)
                .map(FilmEntity::getImages)
                .orElse(List.of())
                .stream()
                .map(imageFilmEntity -> {
